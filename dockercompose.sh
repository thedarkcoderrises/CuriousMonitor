...
docker run -d -p 8081:8081 -v /home/ec2-user/logs:/logs -e HOST_NAME=socat -e kafka.url=kafka:9092 -e AWS=18.220.228.226 -e LOCAL= --name curious --link=socat --link=consul --link=kafka curious:1.0
